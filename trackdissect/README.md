...
[![Backend](https://img.shields.io/badge/Backend-FastAPI-0f172a?style=for-the-badge&logo=fastapi)](main.py)
[![Frontend](https://img.shields.io/badge/Frontend-Vanilla%20HTML%2FCSS%2FJS-1f2937?style=for-the-badge)](index.html)
[![Separation](https://img.shields.io/badge/Stem%20Engine-Demucs-111827?style=for-the-badge)](separator.py)
[![Analysis](https://img.shields.io/badge/Audio%20Features-Librosa-1e3a8a?style=for-the-badge)](analyzer.py)
[![AI](https://img.shields.io/badge/AI-Gemini%20Primary%20%7C%20Claude%20Fallback-374151?style=for-the-badge)](ai_report.py)
[![Python](https://img.shields.io/badge/Python-3.10%2B-2b6cb0?style=for-the-badge&logo=python)](requirements.txt)
...
> Design note
>
> This repository prioritizes a low-friction local trial flow: single-command launch, self-healing setup, and predictable API behavior.
...
- Skip AI report mode for stem-only fast workflows
- EDM-specialized separation:
	- Sub-bass vs mid-bass split (80 Hz crossover)
	- Kick vs top-drums split (120 Hz isolation)
	- Lead vocal vs vocal layers split via mid-side decomposition
- Anti-artifact smoothing (14 kHz high-shelf reduction)
- Metadata preservation for exported stems (artist/title/album and artwork when available)
...
2. User selects trim window and processing quality.
3. Backend trims audio and performs Demucs separation.
4. Specialized vocal, bass, and drum splits are generated.
5. Stems are post-processed and metadata-preserved.
6. Librosa features and AI analysis build the production report.
7. Frontend displays progress, logs, stems, and full narrative output.
...
- Track-level features (for example BPM, key, and energy)
- Per-stem technical features
- AI production report with:
...
- Linux: install from your distro package manager (example: apt install ffmpeg)
